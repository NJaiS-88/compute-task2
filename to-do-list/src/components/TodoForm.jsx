    ...
    return( <>
                <div>
                    <form onSubmit={submitfunc} className='w-full flex flex-col items-center justify-center'>
                        ...
                        <div className="w-[40vw] text-blue-500 break-words text-bold min-w-[15rem] max-w-[30rem] text-center h-fit py-3">{taskData}</div>
                        <button type="submit" className=" bg-blue-500 text-white p-1 rounded-lg cursor-pointer self-center hover:bg-blue-400 transition duration-150 w-fit h-fit">Add Task</button>
